# Generated by Django 3.1.2 on 2020-10-24 14:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Meal 1', 'Meal 1'), ('Meal 2', 'Meal 2'), ('Meal 3', 'Meal 3'), ('Meal 4', 'Meal 4'), ('VEGETARIAN OPTION', 'VEGETARIAN OPTION')], max_length=50)),
                ('description', models.TextField(max_length=100)),
                ('photo', models.FileField(upload_to='')),
                ('price', models.FloatField()),
                ('delivery', models.CharField(choices=[('Pick Up', 'Pick Up'), ('Delivery', 'Delivery')], default='Delivery', max_length=10)),
                ('created_at', models.DateTimeField(default=datetime.datetime.now)),
                ('add_on', models.BooleanField(default=False)),
                ('addOn_details', models.CharField(blank=True, max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
